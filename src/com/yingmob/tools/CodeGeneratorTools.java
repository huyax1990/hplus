...
public class CodeGeneratorTools {
	...
	public static void main(String[] args) {
		String[] tableArr = {"ads_noicon_channel_relation"};
		String[] classNameArr = {"AdsNoiconChannelRelation"};
		String[] classNameSmallArr = {"adsNoiconChannelRelation"};

		String srcFolder = "src";
		String packageBase = "com.yingmob.web";
