package com.yingmob.base.model;
...
public class SysLoginLogModel extends Model<SysLoginLogModel> {
	...
	public void logLogin(SysUserModel user, String ip) {
		new SysLoginLogModel().set("userID", user.get("id")).set("username", user.get("username")).set("loginIP", ip).set("loginDate", new Date()).save();
	}
